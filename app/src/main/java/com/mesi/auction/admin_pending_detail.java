...
public class admin_pending_detail extends Fragment {
    ...
    DBHelper db;
    Button admin_delete_item;

    public admin_pending_detail() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         View v = inflater.inflate(R.layout.fragment_admin_pending_detail, container, false);
    ...
    private void setZdiscription(View v) {
        ...
        admin_delete_item = v.findViewById(R.id.admin_delete_item);
        bidders_list = v.findViewById(R.id.bidders_list);

        admin_delete_item.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void deleteItemAdmin() {

        AlertDialog.Builder alert = new AlertDialog.Builder(getContext());
        alert.setTitle("Alert.");
        alert.setMessage("Do you really wanna delete this item.");

        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {

                if (db.deleteItem(singleDAO.getSingleInstance().getItem_id())) {
                    Toast.makeText(getContext(), "Successfully deleted.", Toast.LENGTH_SHORT).show();
                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new admin_all_item()).commit();
                } else
                    Toast.makeText(getContext(), "You can't delete active item.", Toast.LENGTH_SHORT).show();
            }
        });
